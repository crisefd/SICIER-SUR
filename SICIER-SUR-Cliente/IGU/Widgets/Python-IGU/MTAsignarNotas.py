...
#
# Created: Tue May 12 10:35:59 2015
...
class VentanaAsignarNotas(QtGui.QFrame):
    ...
    def retranslateUi(self, VentanaAsignarNotas):
        ...
        self.botonBuscar.setText(_translate("VentanaAsignarNotas", "Buscar", None))
        self.comboAtributos.setItemText(0, _translate("VentanaAsignarNotas", "Nombre", None))
        self.comboAtributos.setItemText(1, _translate("VentanaAsignarNotas", "Apellido", None))
        self.comboAtributos.setItemText(2, _translate("VentanaAsignarNotas", "ID", None))
        self.comboAtributos.setItemText(3, _translate("VentanaAsignarNotas", "Correo", None))
        self.comboAtributos.setItemText(4, _translate("VentanaAsignarNotas", "Ciudad", None))
        self.etiquetaBuscar.setText(_translate("VentanaAsignarNotas", "Buscar por:", None))
        self.etiquetaIDActualizar_2.setText(_translate("VentanaAsignarNotas", "Actualizar Notas al LT con ID", None))
        self.botonBuscar_2.setText(_translate("VentanaAsignarNotas", "Buscar", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("VentanaAsignarNotas", "Buscar LT", None))
        self.tab.setToolTip(_translate("VentanaAsignarNotas", "<html><head/><body><p><br/></p></body></html>", None))
        self.etiquetaIDActualizar.setText(_translate("VentanaAsignarNotas", "Actualizar Notas al LT con ID", None))
        self.etiquetaIDActualizar_3.setText(_translate("VentanaAsignarNotas", "Actividad con ID", None))
        self.etiquetaIDActualizar_4.setText(_translate("VentanaAsignarNotas", "Nota", None))
        self.pushButton_2.setText(_translate("VentanaAsignarNotas", "Actializar", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("VentanaAsignarNotas", "Actualizar Notas", None))
        self.pushButton.setText(_translate("VentanaAsignarNotas", "Cancelar", None))
